...
CondCommand::CondCommand(Shell *shell, string *parts, int wordCount) :
		ShellCommand(shell, parts, wordCount) {

	parseCommand(parts, wordCount);
}

void CondCommand::parseCommand(string *parts, int wordCount) {
